...
// this function takes the top-answerer by tag object returned by StackOverflow 
// and creates new result to be appended to DOM
var showAnswerer = function(answerer) {
	
	// clone our result template code
	var result 			= $('.templates .answerer').clone(),
		profileLink 	= result.find('.profile-link'),
		profileImage 	= result.find('.profile-image'),
		displayName 	= result.find('.display-name'),
		score 			= result.find('.score'),
		reputation 		= result.find('.reputation');
